...
import br.com.alura.adopet.api.dto.ReprovacaoAdacaoDTO;
...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoAdocaoDTO dto) {
        ...
        emailService.enviarEmail(adocao.getPet().getAbrigo().getEmail(),
                ...
                "Olá " + adocao.getPet().getAbrigo().getNome() + "!\n\nUma solicitação de adoção foi " +
                        "registrada hoje para o pet: " + adocao.getPet().getNome() + ". \nFavor avaliar para aprovação " +
                        "ou reprovação.");
    }
    ...
    public void reprovar(ReprovacaoAdacaoDTO dto) {
        Adocao adocao = adocaoRepository.getReferenceById(dto.idAdocao());
